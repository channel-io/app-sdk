...
const contracts: Contract[] = [
  ...
  contract("OAuthStepDisplay", OAuthStepDisplaySchema, "extension", "OAuthStepDisplay"),
  contract(
    "OAuthStepLocalizedText",
    OAuthStepLocalizedTextSchema,
    "extension",
    "OAuthStepLocalizedText"
  ),
  contract("OAuthFlowStep", OAuthFlowStepSchema, "extension", "OAuthFlowStep"),
  ...
  contract("TaxLine", TaxLineSchema, "extension", "OrderTaxLine"),
  contract("OrderAttribute", OrderAttributeSchema, "extension", "OrderAttribute"),
  contract("ShippingLine", ShippingLineSchema, "extension", "OrderShippingLine"),
