...
| Polling          | decorators                                     | `registerExtension("polling", "v1")`                                  | scope-specific resolvers return channel or manager pages; pollers are normal app functions              | [polling.md](./polling.md)                                                                    |
| Suggestion       | decorators or static helper                    | `registerExtension("suggestion", "v1")`                               | none; AppStore snapshots URL and locale keyword triggers during registration                            | [suggestion.md](./suggestion.md)                                                              |
...
| User auth        | decorators                                     | `registerExtension("userAuthorization", "v1")`                        | none; AppStore reads the policy snapshot during registration                                            | [user-authorization.md](./user-authorization.md)                                              |
...
| ALF task         | decorators                                     | `registerExtension("alfTask", "v1")`; registration triggers sync      | `getAlfTaskVersions`                                                                                    | [alf-task.md](./alf-task.md)                                                                  |
| Notebook         | decorators                                     | `registerExtension("notebook", "v1")`; registration triggers sync     | `getAppNotebookVersions`                                                                                | [notebook.md](./notebook.md)                                                                  |
...
- OAuth is an auth Extension. Use Config for setup UI, stored credentials, validation, and
